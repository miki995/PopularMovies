...
public class MoviesOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_TABLE =
            "create table " + MoviesContract.MoviesEntry.TABLE_MOVIES + " ("
                    ...
                    + MoviesContract.MoviesEntry.MOVIE_ORIG_TITLE + " text , "
    ...
    public static ContentValues getMovieContentValues(Movies movies) {
        ...
        values.put(MoviesContract.MoviesEntry.MOVIE_ORIG_TITLE, movies.getOrig_title());
        values.put(MoviesContract.MoviesEntry.MOVIE_LANGUAGE, movies.getOrig_language());
